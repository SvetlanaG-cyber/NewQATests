export default {
    ...
    loginBgHeight: '1200.9px',
    loginBgWidth: '1019.2px',
    loginBgPosition: 'absolute',
    loginBgTextSizeAdjust: '100%',
    loginFormBgColor: 'rgba(255,255,255,1)',
    loginFormWidth: '450px',
    loginFormTextSizeAdjust: '100%',
    loginFormPaddingBottom: '44px',
    loginFormPaddingleft: '50px',
    loginFormPaddingRight: '58px',
    loginFormPaddingTop: '38px',

    loginFormTitle1Attribute: 'CONNECTIONS',
    loginFormTitle1Color: 'rgba(55,161,185)',
    loginFormTitle1MarginTop: '20px',
    loginFormTitle1MarginBottom: '20px',
    loginFormTitle1LineHeight: '28.5714px',
    ...
    loginFormTitle3LineHeight: '25px',
